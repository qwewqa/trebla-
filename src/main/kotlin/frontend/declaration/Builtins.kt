...
enum class BuiltinFunctionVariant(val returns: Boolean = true, val ir: FunctionIRNodeVariant) {
    ...
    EaseOutInSine(ir = FunctionIRNodeVariant.EaseOutInSine),
    ...
    EaseOutInQuad(ir = FunctionIRNodeVariant.EaseOutInQuad),
    ...
    EaseOutInCubic(ir = FunctionIRNodeVariant.EaseOutInCubic),
    ...
    EaseOutInQuart(ir = FunctionIRNodeVariant.EaseOutInQuart),
    ...
    EaseOutInQuint(ir = FunctionIRNodeVariant.EaseOutInQuint),
    ...
    EaseOutInExpo(ir = FunctionIRNodeVariant.EaseOutInExpo),
    ...
    EaseOutInCirc(ir = FunctionIRNodeVariant.EaseOutInCirc),
    ...
    EaseOutInBack(ir = FunctionIRNodeVariant.EaseOutInBack),
    ...
    EaseOutInElastic(ir = FunctionIRNodeVariant.EaseOutInElastic),
    ;
}
